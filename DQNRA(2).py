    ...
    for episode in range(100000):
        ...
        while not done:
            ...
            if count_batch % 32 ==0:
                ...
                print(len(save_nextStates))
                save_nextStates = np.array(save_nextStates)
                print(save_nextStates.shape)
                ...
                print("s1", save_actions.shape)
                action_convert = save_actions.reshape(-1)
                print("s2", action_convert.shape, ac_network.action_size)
                print(action_convert.dtype)
